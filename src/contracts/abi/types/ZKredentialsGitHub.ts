...
export interface ZKredentialsGitHubInterface extends utils.Interface {
  functions: {
...
export interface ZKredentialsGitHub extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZKredentialsGitHubInterface;
